                ...
                if (isEmpty(data)) {
                    ...
                    if (data.result.length > 0) {
                        ...
                        data.result.forEach(v => {
                            ...
                            const trainPrice = getTrainPrice(trainInfo[39], trainInfo[53]);
...
const getTrainPrice = (p1, p2) => {

    let retPrice = {};
    let p1Data = {};
    const p1num = p1.length / 10;
    for (var c9 = 0; c9 < p1num; c9++) {
        var db = p1.substring(c9 * 10, c9 * 10 + 10);
    ...
    var dg = "";
    var p2Data = {};
    var p2num = p2.length / 7;
    for (var db = 0; db < p2num; db++) {
        var df = p2.substring(db * 7, db * 7 + 7);
        var da = df.substring(0, 1);
        var dd = df.substring(1, 2);
        var c9 = b5(Number(df.substring(2)) / 10);
        dg += da;
        p2Data[da + dd] = c9
    }
    ...
    for (const key in p1Data) {
        if (Object.hasOwnProperty.call(p1Data, key)) {
            const element = p1Data[key];
            switch (key) {
                case "9":
                    retPrice["tz_p"] = element;
                    retPrice["swz_p"] = element;
                    break;
                case "M":
                    retPrice["zy_p"] = element;
                    break;
                case "O":
                case "S":
                    retPrice["ze_p"] = element;
                    break;
                case "6":
                case "A":
                    retPrice["gg_p"] = element;
                    break;
                case "4":
                case "I":
                    retPrice["rw_p"] = element;
                    break;
                case "F":
                    retPrice["_p"] = element;
                    break;
                case "3":
                case "J":
                    retPrice["yw_p"] = element;
                    break;
                case "2":
                    retPrice["rz_p"] = element;
                    break;
                case "1":
                    retPrice["yz_p"] = element;
                    break;
                case "W":
                    retPrice["wz_p"] = element;
                    break;
                case "5":
                case "D":
                case "E":
